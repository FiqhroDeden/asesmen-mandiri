            ...
            <div>
                <div class="flex justify-between">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Detail Peserta Prestasi.</p>
                      </div>
                      <a class="btn btn-warning" href="{{ route('peserta-prestasi') }}" wire:navigate ><x-tabler-arrow-left class="size-4" /> Kembali</a>
                </div>
