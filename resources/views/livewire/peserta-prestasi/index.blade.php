    ...
    <div class="card w-auto bg-base-100 shadow-xl">
        <div class="card-body">
            <div class="card-title flex items-center justify-between">
                <h2 class="mr-4">Peserta Prestasi</h2>
            </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <div class="tooltip m-1" data-tip="Detail Peserta">
                                    <a href="{{ route('peserta-prestasi.detail', $peserta->no_peserta ) }}" class="btn btn-sm btn-square" wire:navigate>
                                        <x-tabler-info-circle class="text-blue-500 size-5"/>
                                    </a>
                                 </div>

                                @if($peserta->asesmenPrestasi)
                                    @if ($peserta->claim_by == Auth::user()->id)
                                    <div class="tooltip m-1" data-tip="Proses">
                                        <a href="{{ route('peserta-prestasi.asesmen', $peserta->no_peserta ) }}" class="btn btn-sm btn-square" wire:navigate>
