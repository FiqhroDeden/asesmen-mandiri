        ...
        <div>
            @if(Auth::user()->peserta->is_permanen)
                <div role="alert" class="alert alert-success">
                    ...
                    <span>Data nilai Anda telah diverifikasi. Informasi mengenai hasil seleksi mandiri akan disampaikan pada waktu yang akan datang. Terima kasih atas partisipasi Anda dalam menyelesaikan proses Asesmen Mandiri Prestasi.</span>
                </div>
            @else
